...
public class MV_LstItems_CLkOrder {
    ...
    public void GetItem(LinkarClient _LinkarClt, String[] reg, String[] regI, int mvNumber) //NEWFRAMEWORK: Replace LinkarClt for LinkarClient
    {
		...
		tmpCountSV_LstPartial = MvOperations.LkDCount(reg[5].split(DBMV_Mark.VM_str,-1)[mvNumber], DBMV_Mark.SM_str); //NEWFRAMEWORK: Replace MvFunctions for MvOperations
		if (tmpCountSV_LstPartial > numSV_LstPartial) numSV_LstPartial = tmpCountSV_LstPartial;
		tmpCountSV_LstPartial = MvOperations.LkDCount(reg[6].split(DBMV_Mark.VM_str,-1)[mvNumber], DBMV_Mark.SM_str); //NEWFRAMEWORK: Replace MvFunctions for MvOperations		
		if (tmpCountSV_LstPartial > numSV_LstPartial) numSV_LstPartial = tmpCountSV_LstPartial;
